...
export async function updateCabin(formData) {
  try {
    ...
    if (result.modifiedCount === 0) {
      console.error("No cabin was updated. Check the cabin ID.");
...
//   try {
//     // Parse form data
//     const minBookingLength = formData.get("minBookingLength"); // Cabin ID to update
//     const maxBookingLength = formData.get("maxBookingLength");
//     const maxGuestPerBooking = formData.get("maxGuestPerBooking");
//     const breakfastPrice = parseFloat(formData.get("breakfastPrice"));
